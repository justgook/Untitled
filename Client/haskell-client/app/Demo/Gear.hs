...
vertex x y z = GL.vertex $ mkVertex x y z

mkVertex :: Float -> Float -> Float -> GL.Vertex3 GL.GLfloat
mkVertex x y z = GL.Vertex3 (realToFrac x) (realToFrac y) (realToFrac z)

normal :: Float -> Float -> Float -> IO ()
normal x y z = GL.normal $ mkNormal x y z

mkNormal :: Float -> Float -> Float -> GL.Normal3 GL.GLfloat
mkNormal x y z = GL.Normal3 (realToFrac x) (realToFrac y) (realToFrac z)
